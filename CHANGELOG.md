...
* Check deliverability using successful response code instead of message parsing ([#822](https://github.com/amaurymartiny/check-if-email-exists/issues/822)) ([39d0ecd](https://github.com/amaurymartiny/check-if-email-exists/commit/39d0ecdeaf078dce5cdb59cba95ab9e02bce11ee))
...
* Add "recipient address accepted" check ([#489](https://github.com/amaurymartiny/check-if-email-exists/issues/489)) ([5d1e72a](https://github.com/amaurymartiny/check-if-email-exists/commit/5d1e72ae165f335ab97a96c3806e3293289187a2))
* http request body to use `to_emails` ([#502](https://github.com/amaurymartiny/check-if-email-exists/issues/502)) ([36aed56](https://github.com/amaurymartiny/check-if-email-exists/commit/36aed567cf705ef8d20489b2275e3d8ba58b75bb))

### [0.8.11](https://github.com/amaurymartiny/check-if-email-exists/compare/v0.8.10...v0.8.11) (2020-07-11)


### Bug Fixes

* Add "Invalid email address" check ([#471](https://github.com/amaurymartiny/check-if-email-exists/issues/471)) ([3b03617](https://github.com/amaurymartiny/check-if-email-exists/commit/3b03617b81a1f9f6bc1bc6edc8c5d6d9f87eabbb))
* Add possibility to use proxy in Yahoo API request ([#472](https://github.com/amaurymartiny/check-if-email-exists/issues/472)) ([aafcedf](https://github.com/amaurymartiny/check-if-email-exists/commit/aafcedf9b9135a6550e7aa2da5d7ca5898da9b53))
...
* Make using Yahoo API optional ([#460](https://github.com/amaurymartiny/check-if-email-exists/issues/460)) ([1e42f0a](https://github.com/amaurymartiny/check-if-email-exists/commit/1e42f0abef27dcea9a467f677ef9a080a3cc0f18))
