...
| `RCH_HOTMAIL_USE_HEADLESS`          | No                          | If set to `1`, use a headless navigator to Hotmail's password recovery page to check Hotmail/Outlook addresses. Requires a local instance of Chrome/Chromium.        | not defined        |
