...
[![](https://img.shields.io/appveyor/ci/amaurymartiny/check-if-email-exists-a08kp.svg)](https://ci.appveyor.com/project/amaurymartiny/check-if-email-exists-a08kp)
